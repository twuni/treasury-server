...
import org.twuni.money.treasury.responder.transaction.MergeTransaction;
...
public class MergeResponder implements Responder {
	...
	public MergeResponder( Factory<Treasury> treasuryFactory, Connection connection ) {
	...
	public Response respondTo( Request request ) {
		MergeTransaction transaction = new MergeTransaction( new String( request.getContent() ), treasuryFactory, adapter );
